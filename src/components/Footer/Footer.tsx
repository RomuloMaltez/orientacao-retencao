    ...
    return (
        <footer className="mt-10 border-t-4 border-[#FFDD00] bg-[#70B643]">
            <div className="mx-auto w-full max-w-5xl px-4 py-6 sm:py-8 md:py-10">
                {/* Header do Footer */}
                <div className="mb-8 flex flex-col items-center gap-6 sm:mb-10 sm:flex-row sm:justify-between sm:gap-6">
                    {/* Logos */}
                    <div className="flex items-center justify-center">
                        <Image
                            ...
                            width={110}
                            height={110}
                            className="h-auto w-[120px] drop-shadow-lg sm:w-[130px] md:w-[140px]"
                            priority
                        />
                    </div>
                    ...
                    <article className="flex flex-col rounded-xl border border-white/40 bg-white/95 p-4 text-[color:var(--pv-blue-900)] shadow-lg shadow-black/10 sm:p-5 md:col-span-2 lg:col-span-1">
                        ...
                        <div className="mt-3 flex-1 space-y-3 sm:mt-4 sm:space-y-4">
                            <p className="text-[0.8rem] leading-relaxed text-[color:var(--pv-blue-900)]/80 sm:text-sm">
                                Acompanhe nossos canais oficiais e fique por dentro das novidades.
                            </p>
                                ...
                                {socialLinks.map(({ label, href, icon: Icon }) => {
                                    ...
                                    return (
                                        <a
                                            ...
                                            target="_blank"
                                            rel="noopener noreferrer"
                                            className={`group flex items-center gap-2 rounded-lg border px-3 py-2 shadow-sm transition hover:shadow-md sm:px-4 sm:py-2.5 ${isInstagram
                                                ? "border-[#F7A1C4] bg-[#FDE9F1] hover:bg-[#F9C5DA]"
                                                : "border-[#70B643] bg-white hover:bg-[#70B643]/10"
                                                }`}
                                        >
                                            <span
                                                className={`flex h-7 w-7 items-center justify-center rounded transition group-hover:scale-110 sm:h-8 sm:w-8 sm:rounded-md ${isInstagram
                                                    ? "bg-gradient-to-br from-[#f58529] via-[#dd2a7b] to-[#8134af] p-[1px]"
                                                    : "border-2 border-[#70B643] bg-white"
                                                    }`}
                                            >
                                                <span
                                                    className={`flex h-full w-full items-center justify-center rounded sm:rounded-md ${isInstagram ? "bg-white text-[#C13584]" : "bg-white text-[#70B643]"
                                                        }`}
                                                >
